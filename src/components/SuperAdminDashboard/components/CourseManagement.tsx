...
import { PencilIcon, TrashIcon, PlusIcon, X, GraduationCap, Upload } from 'lucide-react';
import toast from 'react-hot-toast';
import { CourseBulkUploadModal, CSVCourse } from './CourseBulkUploadModal';
...
export function CourseManagement() {
  ...
  const handleBulkUpload = async (courses: CSVCourse[]) => {
    setUploadStatus({
    ...
    // Replace the previous toast and loadCourses() call with this cleaner implementation
    setTimeout(() => {
      toast.success(`Successfully uploaded ${uploadStatus.success} out of ${uploadStatus.total} courses`);
      loadCourses();
