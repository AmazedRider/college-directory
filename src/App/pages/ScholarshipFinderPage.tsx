...
export function ScholarshipFinderPage() {
  ...
  // Filter scholarships based on search query, category, and country
        ...
        <div className="max-w-5xl mx-auto mb-12 bg-white p-4 rounded-lg border border-gray-200 shadow-sm">
          <form onSubmit={handleSearch} className="flex flex-col md:flex-row gap-4">
            ...
            <div className="relative w-full md:w-auto">
              <select
                className="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary sm:text-sm appearance-none pr-8"
            ...
            <div className="col-span-full text-center py-12">
              ...
              <p className="text-gray-600 mb-4">
                {searchQuery || selectedCategory !== 'All Categories' || selectedCountry !== 'All Countries'
                  ? "Try adjusting your search criteria, category, or country selection."
                  ...
                  {scholarship.countries && scholarship.countries.length > 0 && (
                    <div className="mt-2 flex items-center text-gray-500 text-sm">
                      ...
                      <span>
                        ...
                        {scholarship.countries.length > 2 && ` +${scholarship.countries.length - 2} more`}
                      </span>
                    </div>
                  )}
                  {scholarship.country && !scholarship.countries && (
                    <div className="mt-2 flex items-center text-gray-500 text-sm">
                      <Globe className="h-4 w-4 mr-1" />
